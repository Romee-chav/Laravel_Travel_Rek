@extends('layouts.app')
@section('title', 'Travel Rek - Phuket & Krabi')
@section('content')
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('phuket-store-basic') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="CheckIn" type="time" name="arrival_flight" class="form-control"
                                            placeholder="SQ-423">
                                            <span class="text-danger">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="CheckIn" type="time" name="dept_flight" class="form-control"
                                            placeholder="SQ-423">
                                            <span class="text-danger">
                                            @error('dept_flight')
                                                {{ $message }}
                                    ...
                                    <fieldset class="row mb-3">
                                        <div class="col-sm-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="wakeup_aonang-krabi"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="ashlee_plaza_patong_hotel_&_spa_Phuket"
                                                    id="gridRadios2" value="2">
                                                <label class="form-check-label" for="gridRadios2">
                                                    Ashlee Plaza Patong Hotel & Spa Phuket
                                                </label>
                                            </div>
                                        </div>
                                    </fieldset>
