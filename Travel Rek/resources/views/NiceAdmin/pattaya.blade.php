@extends('layouts.app')
@section('title', 'Travel Rek - Pattaya')
@section('content')
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('pattaya-store-basic') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" name="guest_name" class="form-control">
                                        <span class="text-danger">
                                            @error('guest_name')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="time" id="CheckIn" name="dept_flight" class="form-control"
                                            placeholder="SQ-423">
                                        <span class="text-danger">
                                            @error('dept_flight')
                                                {{ $message }}
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="date" name="check_in" id="formFile">
                                        <span class="text-danger">
                                            @error('check_in')
                                                {{ $message }}
                                            @enderror
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Grand Total USD :</label>
                                <div class="col-sm-10">
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <fieldset class="row mb-3">
                                        <div class="col-sm-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="golden_beach_hotel"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="baron_beach_hotel"
                                            ...
                                            <div class="form-check disabled">
                                                <input class="form-check-input" type="radio" name="the_beverly_hotel"
                                                    id="gridRadios" value="3">
                                ...
                                <div class="checkbox checkbox-inline checkbox-inline-shift">
                                    <input type="checkbox" name="hkt[]" id="pattaya_apt" value="HKT APT-KBV HTL-HKT HTL- HKT APT">
                                    <label for="pattaya_apt" style="padding-left: 2px;">
                                        HKT APT-KBV HTL-HKT HTL- HKT APT
                                    </label>
                                </div>
                                {{-- <div class="row mb-3">
                                        <div class="col-sm-10">
