@extends('layouts.app')
@section('title', 'Travel Rek - My Profile')
@section('content')
                                    ...
                                    <form method="POST" action="{{ route('change-password') }}">
                                        ...
                                        <div class="row mb-3">
                                            <label for="newPassword" class="col-md-4 col-lg-3 col-form-label">New
                                                Password</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="new_password" type="password" name="new_password"
                                        ...
                                        <div class="row mb-3">
                                            <label for="renewPassword" class="col-md-4 col-lg-3 col-form-label">Re-enter
                                                New Password</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="renewpassword" type="password" name="new_confirm_password"
